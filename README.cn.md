...
![elio](https://repo.x-cmd.io/elio.svg?lang=zh)
...
合计: **124,603** 行代码（覆盖前 5 种语言、共 **646** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 118,751 | 1,092 | 12,869 | 623 |
| Toml | 5,701 | 179 | 1,499 | 14 |
| RPMSpecfile | 115 | 0 | 26 | 1 |
| Makefile | 36 | 0 | 2 | 1 |
| Markdown | 0 | 817 | 299 | 7 |

## 源代码

- **上游仓库**: <https://github.com/elio-fm/elio>
- **官网**: <https://elio-fm.github.io/>
- **许可证**: MIT
...
- **Star**: 858 · **Fork**: 27 · **开放 issue**: 71 · **贡献者**: 4

## 累计统计

- **发布数**: 17 · **已合并 PR**: 214 · **开放 PR**: 0 · **已关闭 issue**: 66 · **开放 issue**: 5 · **提交数**: 646

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-15 | 1 | 13 | 0 | 1 | 1 | 65 |
| last60d | 2026-07-16 | 4 | 36 | 0 | 9 | 4 | 105 |
| 90d | 2026-06-16 | 6 | 77 | 0 | 23 | 4 | 150 |
| last180d | 2026-03-18 | 17 | 214 | 0 | 66 | 5 | 387 |
| 360d | 2025-09-19 | 17 | 214 | 0 | 66 | 5 | 639 |
| last720d | 2024-09-24 | 17 | 214 | 0 | 66 | 5 | 646 |
...
elio 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `elio` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/elio.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260914.yml` · 2026-09-14T05:29:48Z._
